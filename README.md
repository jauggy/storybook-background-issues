...
This project was created from another project: https://blog.harveydelaney.com/creating-your-own-react-component-library/

Storybook by default doesn't support SASS so this was the main motivation for using his project. Then I made the following changes:

1. Upgrade to the latest version of storybook
2. Add storybook essential addons
3. Add [CoreUI React library](https://www.npmjs.com/package/@coreui/react)

Below is the documentation from the original project.
